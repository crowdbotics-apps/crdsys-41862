"""
Django settings for crdsys_41862 project.
...
ROOT_URLCONF = 'crdsys_41862.urls'
...
WSGI_APPLICATION = 'crdsys_41862.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "crdsys_41862 API",
    "DESCRIPTION": "API documentation for crdsys_41862 App",
    "VERSION": "v1",
}
